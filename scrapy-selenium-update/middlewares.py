...
class SeleniumMiddleware:
    ...
    def __init__(self, driver_name, driver_executable_path,
        browser_executable_path, command_executor, driver_arguments, driver_experimental_options):
        ...
        driver_experimental_options: Default:None or dict
            The dict of experimental arguments to initialize the driver
        ...
        if driver_experimental_options:
            driver_options.add_experimental_option("prefs", driver_experimental_options)  
    ...
    def process_request(self, request, spider):
        ...
        # Decodifica a url encodada da maneira errada
        request._url = request.url.replace("?_escaped_fragment_=", "#!")
        request._url = request.url.replace(r"%2F", "/")

        self.driver.get(request._url)
